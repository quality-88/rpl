                ...
                <div class="card-body">
                    <form name="frmInput" action="<?= $__routes_mod; ?>/ubah/simpan" method="POST"
                        ...
                        <div class="form-group my-lg-4">
                            ...
                            <input name="__Singkatan" class="form-control" autocomplete="off" placeholder="Singkatan"
                                maxlength="1"
                                value="<?= isset($_SESSION['__Old_Data']['__Singkatan']) ? $_SESSION['__Old_Data']['__Singkatan'] : @$__record_data__->Singkatan; ?>"
                                required>
                            <div>
                                <small class="text-danger">
                                    <?= isset($_SESSION['__Form_Notifikasi__']['__Singkatan']) ? $_SESSION['__Form_Notifikasi__']['__Singkatan'] : ''; ?>
                                </small>
                            </div>
                        </div>
                        <div class="form-group my-lg-4">
