<div class="container-xxl">
    ...
    <?php if ( !isset($__record_data__) AND @$__record_data__ == FALSE ) { ?>
    <div class="row mb-4">
                                ...
                                <table id="myTable" class="table table-striped table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Profesiensi</th>
                                            <th class="text-center">Hasil Evaluasi Asesor</th>
                                    ...
                                    <tbody class=" table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= url('/homeadmin'); ?>/settingdata_profesiensi?__Id=<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record__->Id . '|\|' . time() , 221 , 5 ); ?>"
                                            ...
                                            <td class="text-center">
                                                <a href="<?= url('/homeadmin'); ?>/settingdata_hasilevaluasiasesor?__Id=<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record__->Id . '|\|' . time() , 221 , 5 ); ?>"
                                                    class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
                                                    data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                                    title="Hasil Evaluasi Asesor">
                                                    Hasil Evaluasi
                                                    <br>
                                                    Asesor
                                                </a>
                                            ...
                                            <td class="text-left">
                                                <?= htmlspecialchars_decode( $__record__->Keterangan ); ?>
                                            </td>
                                            <td class="text-center">
