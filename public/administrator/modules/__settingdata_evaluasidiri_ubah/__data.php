                ...
                <div class="card-body">
                    <form name="frmInput" action="<?= $__routes_mod; ?>/ubah/simpan" method="POST"
                        ...
                        <div class="form-group my-lg-4">
                            ...
                            <textarea name="__Keterangan" class="ckeditor" id="ckedtor" autocomplete="off"
                                minlength="25">
                                <?= isset($_SESSION['__Old__']['__Keterangan']) ? $_SESSION['__Old__']['__Keterangan'] : htmlspecialchars_decode( @$__record_data__->Keterangan ); ?>
                            </textarea>
                        </div>
                        <div class="form-group ">
                            ...
                            <a href="<?= $__routes_mod; ?>" class="btn btn-danger" data-bs-toggle="tooltip"
                                data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="Kembali">
                                Kembali
                            </a>
                        </div>
                    </form>
