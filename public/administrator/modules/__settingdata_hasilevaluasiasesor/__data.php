                        ...
                        <div class="accordion-body">
                            <form name="frmInput" action="<?= $__routes_mod; ?>/simpan" method="POST"
                                ...
                                <div class="form-group my-lg-4">
                                    ...
                                    <input name="__Singkatan" class="form-control" autocomplete="off"
                                        placeholder="Singkatan" maxlength="1"
                                        value="<?= isset($_SESSION['__Old_Data']['__Singkatan']) ? $_SESSION['__Old_Data']['__Singkatan'] : ''; ?>"
                                        required>
                                    <div>
                                        <small class="text-danger">
