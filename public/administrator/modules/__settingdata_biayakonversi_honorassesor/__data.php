<div class="container-xxl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="<?= $__routes_mod; ?>/honorassesor?__Id=<?= $_GET['__Id']; ?>">
                    Honor Assesor
                </a>
            </li>
        </ol>
        ...
        <div class="col-xxl col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">
                    Data Setting Honor Assesor
                </h5>
                <div class="card-body">
                    <form name="frmInput" action="<?= $__routes_mod; ?>/honorassesor/simpan" method="POST"
                        ...
                        <input type="hidden" name="__Url" class="form-control"
                            value="<?= $__routes_mod; ?>/honorassesor?__Id=<?= $_GET['__Id']; ?>" required readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="__Honor" class="form-control" autocomplete="off"
                                        placeholder="Honor" maxlength="7" onkeypress="return TextAngka(event)"
                                        value="<?= isset($_SESSION['__Old__']['__Honor']) ? $_SESSION['__Old__']['__Honor'] : $__record_data__->Honor + 0; ?>"
                                        required>
                                </div>
                            </div>
