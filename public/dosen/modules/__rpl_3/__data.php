                            ...
                            <table class="table table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Info <br> Assesor 1</th>
                                        <th class="text-center">Info <br> Assesor 2</th>
                                ...
                                <tbody class=" table-border-bottom-0">
                                    ...
                                    <?php 
                                        ...
                                        foreach ( $__record_data_assesor_3__ AS $data => $__record_assesor_3__ ) : 

                                            $__mahasiswa__ = $__db->queryid(" SELECT Id_Rpl_Pendaftaran AS Id, Nama_Rpl_Pendaftaran AS Nama, Prodi_Rpl_Pendaftaran AS Prodi FROM Tbl_Rpl_Pendaftaran WHERE Id_Rpl_Pendaftaran = '". $__record_assesor_3__['Id_Rpl_Pendaftaran'] ."' ORDER BY Id_Rpl_Pendaftaran DESC ");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ( $__record_assesor_3__['Check_As_2'] == 'Y' ) { ?>
                                            <div>
                                                <?php if ( date('Y-m-d H:i:s', strtotime($__record_assesor_3__['TglHapus_3'])) > date('Y-m-d H:i:s') OR $__record_assesor_3__['Cek_Status'] == 'Y' ) { ?>
                                                <a href="<?= $__routes_mod; ?>/cms_3?__Id=<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record_assesor_3__['Id'] . '|\|' . time() , 221 , 5 ); ?>"
                                                    class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
                                                    data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                                    title="Input Berita Acara">
                                                    Input <br> Berita Acara
                                                </a>
                                                <?php } else {?>
                                            ...
                                            <div>
                                                <span class="badge bg-danger">
                                                    Assesor 2 <br><br> Belum Selesai
                                                </span>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if ( isset($__record_assesor_3__['Hp_1']) AND $__record_assesor_3__['Hp_1'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_3__['Hp_1']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
                                            ...
                                            <?php } ?>
                                            <?php if ( isset($__record_assesor_3__['Telepon_1']) AND $__record_assesor_3__['Telepon_1'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_3__['Telepon_1']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
                                        ...
                                        <td class="text-center">
                                            <?php if ( isset($__record_assesor_3__['Hp_2']) AND $__record_assesor_3__['Hp_2'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_3__['Hp_2']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
                                                target="_Blank" class=" btn btn-sm btn-success my-2"
                                                data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top"
                                                data-bs-html="true" title="Konfirasi">
                                                <i class="bx bxl-whatsapp"></i>
                                            ...
                                            <?php } ?>
                                            <?php if ( isset($__record_assesor_3__['Telepon_2']) AND $__record_assesor_3__['Telepon_2'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_3__['Telepon_2']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
                                                target="_Blank" class=" btn btn-sm btn-warning my-2"
                                                data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top"
                                                data-bs-html="true" title="Konfirasi">
                                                <i class="tf-icons bx bx-phone"></i>
