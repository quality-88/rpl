<div class="container-xxl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a
                    href="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail/konversi/upload?__Id=<?= $_GET['__Id']; ?>&__IdBerkas=<?= $_GET['__IdBerkas']; ?>&__IdPerolehan=<?= $_GET['__IdPerolehan']; ?>&__IdCpmk=<?= $_GET['__IdCpmk']; ?>">
                    Upload
                </a>
            </li>
        </ol>
    ...
    <div class="row mb-4">
        <div class="col-md mb-4 mb-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form name="frmInput"
                        action="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail/konversi/upload/simpan"
