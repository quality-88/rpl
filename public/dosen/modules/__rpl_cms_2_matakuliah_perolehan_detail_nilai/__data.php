<div class="container-xxl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a
                    href="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail/nilai?__Id=<?= $_GET['__Id']; ?>&__IdBerkas=<?= $_GET['__IdBerkas']; ?>&__IdPerolehan=<?= $_GET['__IdPerolehan']; ?>">
                    Nilai
                </a>
            </li>
        </ol>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                    <form name="frmInput"
                                        action="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail/nilai/simpan"
                                        ...
                                        <input type="hidden" name="__Url" class="form-control"
                                            value="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail/nilai?__Id=<?= $_GET['__Id']; ?>&__IdBerkas=<?= $_GET['__IdBerkas']; ?>&__IdPerolehan=<?= $_GET['__IdPerolehan']; ?>&__IdCpmk=<?= $_GET['__IdCpmk']; ?>"
                                            required readonly>

                                        <input type="hidden" name="__Url_Success" class="form-control"
                                            value="<?= $__routes_mod; ?>/cms_2/matakuliah_perolehan/detail?__Id=<?= $_GET['__Id']; ?>&__IdBerkas=<?= $_GET['__IdBerkas']; ?>&__IdPerolehan=<?= $_GET['__IdPerolehan']; ?>"
                                            required readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-xxl col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <p>
                                                    Silahkan input nilai yang sesuai untuk matakuliah konversi perolehan
                                                    ini
                                                </p>
                                                <hr>
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="__NilaiMk"
                                                                autocomplete="off" placeholder="Nilai Matakuliah"
                                                                value="<?= isset($_SESSION['__Old__']['__NilaiMk']) ? $_SESSION['__Old__']['__NilaiMk'] : $__data_mk_perolehan->Nilai; ?>"
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="__HurufMk"
                                                                autocomplete="off" placeholder="Nilai Matakuliah"
                                                                value="<?= isset($_SESSION['__Old__']['__HurufMk']) ? $_SESSION['__Old__']['__HurufMk'] : $__data_mk_perolehan->Huruf; ?>"
                                                                required oninput="this.value = this.value.toUpperCase()"
                                                                maxlength="2">
                                                        </div>
                                                    </div>
