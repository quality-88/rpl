    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a
                    href="<?= $__routes_mod; ?>?__Ta=<?= $__record_data__->Ta_1; ?>&__Semester=<?= $__record_data__->Semester_1; ?>">
                    RPL
                </a>
            </li>
            <li class="breadcrumb-item active">
    ...
    <div class="row mb-4">
        <div class="col-xl-12 col-md-12 col-sm-12 mb-4 mb-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form name="frmInput" action="<?= $__routes_mod; ?>/cms_1/simpan" method="POST"
                        ...
                        <input type="hidden" name="__Url" class="form-control"
                            value="<?= $__routes_mod; ?>/cms_1?__Id=<?= $_GET['__Id']; ?>" required readonly>

                        <input type="hidden" name="__Id" class="form-control" value="<?= $_GET['__Id']; ?>" required
                            readonly>

                        <input type="hidden" name="__IdRpl" class="form-control"
                            value="<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__calon_rpl__->Id . '|\|' . time() , 221 , 5 ); ?>"
                            required readonly>

                        <input type="hidden" name="__Assesor" class="form-control"
                            value="<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record_data__->D_1 . '|\|' . time() , 221 , 5 ); ?>"
                            required readonly>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <label>
                                        ...
                                        <small class="text-danger">
                                            Contoh :
                                            <?= $__universitas->__Detail_Universitas()['Singkat'] . rand(0,9999) . chr(rand(65, 90)) . chr(rand(65, 90)) . rand(0,99); ?>
                                        </small>
                                    </label>
                                    <input class="form-control" type="text" name="__IdMk" autocomplete="off"
                                        placeholder="ID Matakuliah Asal"
                                        value="<?= isset($_SESSION['__Old__']['__IdMk']) ? $_SESSION['__Old__']['__IdMk'] : ''; ?>"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="__NamaMk" autocomplete="off"
                                        placeholder="Nama Matakuliah Asal"
                                        value="<?= isset($_SESSION['__Old__']['__NamaMk']) ? $_SESSION['__Old__']['__NamaMk'] : ''; ?>"
                                        required oninput="this.value = this.value.toUpperCase()">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="__Sks" autocomplete="off"
                                        placeholder="SKS Matakuliah Asal"
                                        value="<?= isset($_SESSION['__Old__']['__Sks']) ? $_SESSION['__Old__']['__Sks'] : ''; ?>"
                                        required oninput="this.value = this.value.toUpperCase()" maxlength="1"
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="__NilaiMk" autocomplete="off"
                                        placeholder="Nilai Matakuliah Asal"
            ...
            <div class="card">
                <h5 class="card-header">
                    <div class="alert alert-danger alert-dismissible" role="alert">
                        ...
                        <p class="mb-0">
                            Silahkan cek kelengkapan berkas dari Mahasiswa RPL secara keseluruhan,
                            <br>
                            jika terjadi masalah atau kekurangan data silahkan hubungin mahasiswa untuk memperbaiki atau
                            menambahkan berkas !
                        </p>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
                        </button>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div>
                                                    <a href="#" class="btn btn-sm btn-danger __session_delete_data"
                                                        ...
                                                        __slugs="Apakah Yakin Untuk Hapus Data ID Matakuliah <?= $__record__->IdMk; ?> Dengan Nama Matakuliah <?= $__record__->Matakuliah; ?> Ini ?"
                                                        __url="<?= $__routes_mod; ?>/cms_1/hapus?__Id=<?= $_GET['__Id']; ?>&__Id1=<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record__->Id . '|\|' . time() , 221 , 5 ); ?>">
                                                        Hapus
                                                    </a>
                                                </div>
                                                <?php } ?>
