        ...
        <div class="col-xl-12 col-md-12 col-sm-12 mb-4 mb-md-0">
            <div class="nav-align-top mb-6">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="navs-pills-justified-assesor2" role="tabpanel">
                            ...
                            <table class="table table-striped table-hover" style="width:100%">
                                ...
                                <tbody class=" table-border-bottom-0">
                                    ...
                                    <?php 
                                        ...
                                        foreach ( $__record_data_assesor_2__ AS $data => $__record_assesor_2__ ) :
                                            
                                            $__mahasiswa__ = $__db->queryid(" SELECT Id_Rpl_Pendaftaran AS Id, Nama_Rpl_Pendaftaran AS Nama, Prodi_Rpl_Pendaftaran AS Prodi FROM Tbl_Rpl_Pendaftaran WHERE Id_Rpl_Pendaftaran = '". $__record_assesor_2__['Id_Rpl_Pendaftaran'] ."' ORDER BY Id_Rpl_Pendaftaran DESC ");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ( $__record_assesor_2__['Check_As_1'] == 'Y' ) { ?>
                                            <div>
                                                <?php if ( date('Y-m-d H:i:s', strtotime($__record_assesor_2__['TglHapus_2'])) > date('Y-m-d H:i:s') OR $__record_assesor_2__['Cek_Status'] == 'Y' ) { ?>
                                                <a href="<?= $__routes_mod; ?>/cms_2?__Id=<?= @$__secret_key->Encrypt( date('sHis') . '|\|' . $__record_assesor_2__['Id'] . '|\|' . time() , 221 , 5 ); ?>"
                                            ...
                                            <div>
                                                <span class="badge bg-danger">
                                                    Assesor 1 <br><br> Belum Selesai
                                                </span>
                                            </div>
                                            <?php } ?>
                                        </td>
                                        <td class="text-center">
                                            <?php if ( isset($__record_assesor_2__['Hp']) AND $__record_assesor_2__['Hp'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_2__['Hp']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
                                            ...
                                            <?php } ?>
                                            <?php if ( isset($__record_assesor_2__['Telepon']) AND $__record_assesor_2__['Telepon'] == TRUE ) { ?>
                                            <a href="https://api.whatsapp.com/send?phone=<?= $__record_assesor_2__['Telepon']; ?>&text=Mohon Di Nilai Pada Tahap Selanjutnya, Terimakasih"
