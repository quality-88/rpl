<div class="container-xxl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a
                    href="<?= $__routes_mod; ?>/cms_2/matakuliah/upload?__Id=<?= $_GET['__Id']; ?>&__Id1=<?= $_GET['__Id1']; ?>&__IdMk=<?= $_GET['__IdMk']; ?>&__IdMkCpmk=<?= $_GET['__IdMkCpmk']; ?>&__IdCpmk=<?= $_GET['__IdCpmk']; ?>">
                    Upload
                </a>
            </li>
        </ol>
    ...
    <div class="row mb-4">
        <div class="col-md mb-4 mb-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form name="frmInput" action="<?= $__routes_mod; ?>/cms_2/matakuliah/upload/simpan" method="POST"
                        ...
                        <input type="hidden" name="__Url" class="form-control"
                            value="<?= $__routes_mod; ?>/cms_2/matakuliah/upload?__Id=<?= $_GET['__Id']; ?>&__Id1=<?= $_GET['__Id1']; ?>&__IdMk=<?= $_GET['__IdMk']; ?>&__IdMkCpmk=<?= $_GET['__IdMkCpmk']; ?>&__IdCpmk=<?= $_GET['__IdCpmk']; ?>"
                            required readonly>
                        ...
                        <div class="row">
                            <div class="col-xxl col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <select class="form-control select2-kedua" name="__Post_IdKeteranganDokumen"
                                        required>
                                        <option value="" disabled selected>
                                            -- Pilih Bukti Yang Disampaikan --
                                        </option>
                                        <?php foreach ( $__data_keterangandokumen__ AS $data => $__keterangandokumen__ ) : ?>
                                        <option value="<?= $__keterangandokumen__->Id; ?>">
                                            <?= $__keterangandokumen__->Judul; ?> - Format
                                            <?= $__keterangandokumen__->Format; ?> - Ukuran Maksimal
                                            <?= $__keterangandokumen__->Ukuran; ?> MB
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                    <br>
                                    <input type="file" name="__Post_File" autocomplete="off" value="" required>
                                </div>
                                <hr>
                                <div class="form-group">
