    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <a href="<?= url('/homerpl/pumb/cicilan'); ?>">
                    Cicilan
                </a>
            </li>
        </ol>
...
<div class="container-xxl">
    <div class="row mb-4">
        <div class="col-xl-12 col-md-12 col-sm-12 mb-4 mb-md-0">
            <form name="frmInput" action="<?= url('/homerpl/pumb/cicilan/simpan'); ?>" method="POST"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php 
                                                        foreach ( $__data_biaya_alokasibiayakuliah1__ AS $data => $__alokasibiayakuliah1__) : 
                                                            ...
                                                            $__total_biaya_cicilan__ += $__alokasibiayakuliah1__->Biaya + 0;
                                                    ?>
                                                    <tr>
                                                        <td class="text-center">
                                                    ...
                                                    <?php endforeach; ?>
                                                    <?php 
                                                        if ( $__total_biaya_cicilan__ == TRUE AND $__total_biaya_cicilan__ > '0' ) {
                                                            $__total_biaya_cicilan_per__ = $__total_biaya_cicilan__ * $__persen__ / 100; 
                                                        } else {
                                                            $__total_biaya_cicilan_per__ = '0'; 
                                                        }
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            Rp.
                                                            <?= $__helpers->Uang( $__total_biaya_cicilan_per__ ); ?>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <?php 
                                                        foreach ( $__data_biaya_alokasiper1 AS $data => $__alokasiper1__) : 
                                                            ...
                                                            $__total_biaya_cicilan__ += $__alokasiper1__->Biaya + 0;
                                                    ?>
                                                    <tr>
                                                        <td class="text-center">
                                                    ...
                                                    <tr class="bg-warning text-white">
                                                        ...
                                                        <td class="text-left">
                                                            <strong>
                                                                Rp.
                                                                <?php
                                                                    $__subtotal__ = ($__total_biaya__ + $__total_biaya_cicilan_per__);
                                                                    echo $__helpers->Uang( $__subtotal__ ); 
                                                                ?>
                                                            </strong>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="bg-primary text-white">
                                                        ...
                                                        <td class="text-left">
                                                            <strong>
                                                                Rp.
                                                                <?php 
                                                                    $__total_pembayaran__ = $__subtotal__ - $__diskon__;
                                                                    echo $__helpers->Uang( $__total_pembayaran__ ); 
                                                                ?>
                                                            </strong>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="d-grid gap-2 col-lg-12 mx-auto">
                                    <a href="<?= url('/homerpl/pumb'); ?>" class="btn btn-info btn-lg">
                                        Buat Full
                                    </a>
                ...
                <input type="hidden" name="__Biaya" class="form-control" value="<?= $__total_pembayaran__ ; ?>" required
                    readonly>

                <input type="hidden" name="__SubTotal" class="form-control" value="<?= $__subtotal__ + 0; ?>" required
                    readonly>

                <input type="hidden" name="__Alokasi" class="form-control"
                    value="<?= $__total_biaya_cicilan_per__ + 0; ?>" required readonly>

                <input type="hidden" name="__Pmb" class="form-control" value="<?= $__data_biaya_pmb__->Biaya + 0; ?>"
                    required readonly>

                <input type="hidden" name="__Pengelolah" class="form-control"
                    value="<?= $__data_biaya_rpl__->Biaya  + 0; ?>" required readonly>

                <input type="hidden" name="__Persen" class="form-control" value="<?= $__persen__; ?>" required readonly>
