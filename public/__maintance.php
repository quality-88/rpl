...
<body>
    ...
    <div class="misc-wrapper text-center mt-lg-4 mb-lg-4">
        ...
        <p class="mb-4 mx-2">
            Mohon maaf saat ini aplikasi sedang melakukan pembaruan internal.
        </p>
        <div class="mt-3">
            <img src="<?= __Base_Url(); ?>resources/assets/dashboard/assets/img/illustrations/girl-doing-yoga-light.png"
