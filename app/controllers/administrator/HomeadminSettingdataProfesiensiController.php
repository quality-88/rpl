<?php
    ...
    class HomeadminSettingdataProfesiensiController
    {
        protected $__db;
        ...
        {
            return url('/homeadmin/settingdata_profesiensi');
        }
        ...
        public function IndexAdmin_Profesiensi()
        {
            ...
            $__content      = '__settingdata_profesiensi';
            ...
            if ( !isset($_SESSION['__Administrator__']) ) {
                ...
                if ( isset($_GET['__Id']) AND $_GET['__Id'] == TRUE ) {
                    ...
                    $__record_data__ = $this->__ProfesiensiModel->read( ['Id' => $__record_data_evaluasidiri__->Id, 'Id2' => ''] );
        ...
        public function IndexAdmin_Profesiensi_Simpan( array $data )
        {
            $__clean_data = [
                ...
                $__session = [
                    ...
                    try {
                        ...
                        $this->__db->beginTransaction();
                            ...
                            $__query_result = $this->__ProfesiensiModel->create( $__session );
        ...
        public function IndexAdmin_Profesiensi_Ubah()
        {
            $__header       = $this->__Header();
            $__secret_key   = $this->__secret_key;
            $__universitas  = $this->__universitas;
            ...
            $__routes       = url('/homeadmin');
            $__routes_mod   = self::__Routes_Mod__();
            $__content      = '__settingdata_profesiensi/ubah';
            ...
            if ( !isset($_SESSION['__Administrator__']) ) {
                ...
                if ( isset($_GET['__Id']) AND $_GET['__Id'] == TRUE AND isset($_GET['__Id2']) AND $_GET['__Id2'] == TRUE ) {
                    ...
                    $__record_data__ = $this->__ProfesiensiModel->read( ['Id' => $__record_data_evaluasidiri__->Id, 'Id2' => $this->__helpers->SecretOpen( $_GET['__Id2'] )] );
        ...
        public function IndexAdmin_Profesiensi_Ubah_Simpan( array $data )
        {
            $__clean_data = [
                '__Token'           => isset($data['__Token']) ? stripslashes(strip_tags(htmlspecialchars($data['__Token'], ENT_QUOTES))) : '',
                '__Url'             => isset($data['__Url']) ? $data['__Url'] : '',
                ...
                $__session = [
                    ...
                    try {
                        ...
                        $this->__db->beginTransaction();
                            ...
                            $__query_result = $this->__ProfesiensiModel->update( $__session );
