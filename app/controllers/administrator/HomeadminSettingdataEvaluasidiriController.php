<?php
    ...
    class HomeadminSettingdataEvaluasidiriController
    {
        protected $__db;
        ...
        {
            return url('/homeadmin/settingdata_evaluasidiri');
        }
        ...
        public function IndexAdmin_EvaluasiDiri()
        {
            ...
            $__content      = '__settingdata_evaluasidiri';
            ...
            if ( !isset($_SESSION['__Administrator__']) ) {
                ...
                $__record_data__ = $this->__EvaluasiDiriModel->read();
        ...
        public function IndexAdmin_EvaluasiDiri_Simpan( array $data )
        {
            $__clean_data = [
                ...
                $__session = [
                    ...
                    try {
                        ...
                        $this->__db->beginTransaction();
                            ...
                            $__query_result = $this->__EvaluasiDiriModel->create( $__session );
        ...
        public function IndexAdmin_EvaluasiDiri_Ubah()
        {
            $__header       = $this->__Header();
            $__secret_key   = $this->__secret_key;
            $__universitas  = $this->__universitas;
            ...
            $__routes       = url('/homeadmin');
            $__routes_mod   = self::__Routes_Mod__();
            $__content      = '__settingdata_evaluasidiri/ubah';
            ...
            if ( !isset($_SESSION['__Administrator__']) ) {
                ...
                if ( isset($_GET['__Id']) AND $_GET['__Id'] == TRUE ) {
                    ...
                    $__record_data__ = $this->__EvaluasiDiriModel->read( $this->__helpers->SecretOpen( $_GET['__Id'] ) );
        ...
        public function IndexAdmin_EvaluasiDiri_Ubah_Simpan( array $data )
        {
            $__clean_data = [
                '__Token'           => isset($data['__Token']) ? stripslashes(strip_tags(htmlspecialchars($data['__Token'], ENT_QUOTES))) : '',
                '__Url'             => isset($data['__Url']) ? $data['__Url'] : '',
                ...
                $__session = [
                    ...
                    try {
                        ...
                        $this->__db->beginTransaction();
                            ...
                            $__query_result = $this->__EvaluasiDiriModel->update( $__session );
        ...
        public function IndexAdmin_InformasiFile_Hapus()
        {
            ...
            $fileRecord = $this->__EvaluasiDiriModel->read( $fileId ); 
            ...
            $__session = [
                ...
                try {
                    ...
                    $this->__db->beginTransaction();
                        ...
                        $__query_result = $this->__EvaluasiDiriModel->delete( $__session );
